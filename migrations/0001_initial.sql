...
--
-- 迁移基线（v0.1.6 起）：本文件必须与 app/install/schema.sql 内容一致
-- （build-release.php 会校验，不一致直接报错）。安装走 schema.sql 并把本
-- 基线标记为已应用；存量库升级时自动视为已应用；后续结构演进新增
-- migrations/0002_*.sql 增量（见 app/Services/Migrator.php 与 docs/migrations.md）
-- ============================================================
